        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#E9EDEF] px-3 py-2 text-sm text-[#111B21] placeholder:text-[#667781] focus:border-[#25D366] focus:outline-none focus:ring-1 focus:ring-[#25D366]"
              autoComplete="off"
            />
            ...
            <div className="rounded-lg bg-[#F0F2F5] p-4">
              ...
              <div className="mt-3 flex flex-wrap items-end gap-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder="123456"
                    className="w-28 rounded-lg border border-[#E9EDEF] px-3 py-2 text-sm font-mono tracking-widest placeholder:text-[#667781] focus:border-[#25D366] focus:outline-none focus:ring-1 focus:ring-[#25D366]"
                ...
                <button
                  ...
                  className="rounded-lg bg-[#25D366] px-4 py-2 text-sm font-medium text-white hover:bg-[#20BD5C] disabled:opacity-50"
                >
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="rounded-lg border border-[#25D366] bg-white px-4 py-2 text-sm font-medium text-[#25D366] hover:bg-[#25D366]/5 disabled:opacity-50"
                >
          ...
          <div className="rounded-lg bg-amber-50 p-4">
            ...
            <ul className="mt-2 space-y-1 text-xs text-amber-800">
              <li>
                <a href="/privacidad" target="_blank" rel="noopener noreferrer" className="text-[#25D366] underline">
                  /privacidad
                </a>
              </li>
              <li>
                <a href="/terminos" target="_blank" rel="noopener noreferrer" className="text-[#25D366] underline">
                  /terminos
                </a>
              </li>
              <li>
                <a href="/eliminacion-datos" target="_blank" rel="noopener noreferrer" className="text-[#25D366] underline">
                  /eliminacion-datos
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              <div className="flex flex-col items-center gap-2">
                ...
                <label className="cursor-pointer">
                  <span className="rounded-lg border border-[#25D366] px-3 py-2 text-sm font-medium text-[#25D366] hover:bg-[#25D366]/5 inline-block">
              ...
              <div className="flex-1 space-y-3 min-w-0">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-[#E9EDEF] px-3 py-2 text-sm placeholder:text-[#667781] focus:border-[#25D366] focus:outline-none focus:ring-1 focus:ring-[#25D366]"
                    maxLength={139}
                  />
                </div>
                <div>
            ...
            <div>
              ...
              <input
                ...
                className="mb-2 w-full rounded-lg border border-[#E9EDEF] px-3 py-2 text-sm placeholder:text-[#667781] focus:border-[#25D366] focus:outline-none focus:ring-1 focus:ring-[#25D366]"
              />
              <input
                type="url"
                    ...
                    <div key={d} className="flex flex-wrap items-center gap-2">
                      <label className="flex w-24 items-center gap-1">
                        <input
                          ...
                          className="h-4 w-4 rounded border-gray-300 text-[#25D366]"
                        />
        ...
        {catalogLoading ? (
          ...
          <>
            ...
            <form onSubmit={handleAddProduct} className="mb-4 flex flex-wrap gap-2">
              ...
              <button
                type="submit"
                className="rounded-lg bg-[#25D366]/80 px-3 py-2 text-sm font-medium text-white hover:bg-[#25D366]"
              >
                Añadir
              </button>
            </form>
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-[#25D366] px-4 py-2 text-sm font-medium text-[#25D366] hover:bg-[#25D366]/10 disabled:opacity-50"
              >
