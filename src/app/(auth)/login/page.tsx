      ...
      <main className="relative z-10 mx-auto flex max-w-6xl flex-col items-center justify-center px-5 pb-20 pt-4 sm:px-8 lg:flex-row lg:items-stretch lg:gap-12 lg:pb-28">
        <div className="mb-10 max-w-md lg:mb-0 lg:flex-1 lg:pt-8">
          ...
          <p className="mt-5 text-lg leading-relaxed text-[#9fb5a8]">
            Misma línea visual que la landing: oscuro, verde y claro para enfocarte en vender por WhatsApp.
          </p>
        </div>
        ...
        <div className="w-full max-w-md">
          <div className="rounded-3xl border border-white/10 bg-[#0a1210]/90 p-6 shadow-2xl shadow-black/40 backdrop-blur-sm sm:p-8">
            <h2 className={`${fraunces.className} text-xl font-semibold text-white`}>Iniciar sesión</h2>
            {error && (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  {...register("email")}
                  className="mt-2 w-full rounded-xl border border-white/10 bg-[#050807]/80 px-4 py-3 text-[#e8f0ec] outline-none transition placeholder:text-[#5c7368] focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20"
              ...
              <div>
                ...
                <input
                  ...
                  {...register("password")}
                  className="mt-2 w-full rounded-xl border border-white/10 bg-[#050807]/80 px-4 py-3 text-[#e8f0ec] outline-none transition focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20"
                  placeholder="••••••••"
                />
                {errors.password && (
              ...
              >
                {isSubmitting ? "Cargando…" : "Entrar al panel"}
              </button>
            </form>
            <p className="mt-8 text-center text-sm text-[#7a9184]">
              ¿No tienes cuenta?{" "}
              <Link href="/register" className="font-medium text-emerald-300 hover:text-white hover:underline">
                Regístrate
              </Link>
            </p>
          </div>
