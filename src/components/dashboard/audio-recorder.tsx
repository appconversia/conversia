      ...
      {recording ? (
        ...
        <>
          ...
          <button
            ...
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white hover:bg-[#20bd5a]"
            aria-label="Enviar"
          >
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <>
          ...
          <div className="flex-1 text-center">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-6 py-2.5 text-white hover:bg-[#20bd5a]"
            >
